...
"""
    ...
    def _handle_tool_execution(self, initial_response, base_params: Dict[str, Any], tool_manager, max_tool_rounds: int):
        """
        ...
        while rounds_completed < max_tool_rounds and current_response.stop_reason == "tool_use":
            rounds_completed += 1
